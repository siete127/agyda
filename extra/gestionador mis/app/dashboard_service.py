...
SELECT
    ...
    COUNT(DISTINCT CASE WHEN list_id IS NOT NULL AND LTRIM(RTRIM(list_id))<>'' THEN list_id END) AS Lotes,
...
"""
        ...
        by_lot = grouped(
            "COALESCE(NULLIF(LTRIM(RTRIM(list_id)),''),'SIN COINCIDENCIA')",
            "lote",
        )
            ...
            details.append(
                {
                    ...
                    "lote": str(r[7] or "SIN COINCIDENCIA"),
                    "lote_nombre": str(r[8] or ""),
