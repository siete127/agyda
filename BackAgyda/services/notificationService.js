...
const PUSH_CONFIG_POR_TIPO = {
  ...
  'cliente-tarea-vence':            { titulo: 'AGYDA — Atención al Cliente', url: '/atencion-cliente/mis-tareas' },
  'cliente-seguimiento-hoy':        { titulo: 'AGYDA — Atención al Cliente', url: '/atencion-cliente/mis-tareas' },
  'cliente-incidencia-sla-riesgo':  { titulo: 'AGYDA — Atención al Cliente', url: '/atencion-cliente/casos' },
  'cliente-incidencia-sla-vencido': { titulo: 'AGYDA — Atención al Cliente', url: '/atencion-cliente/casos' },
  'cliente-incidencia-portal':      { titulo: 'AGYDA — Atención al Cliente', url: '/atencion-cliente/casos' },
