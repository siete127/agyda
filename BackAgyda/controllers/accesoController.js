...
const ACCIONES_POR_MODULO = {
  crm: [
    ...
    { key: 'facturar',                   nombre: 'Emitir facturas',        descripcion: 'Generar la factura (CFDI) de una cotización aprobada y registrar sus pagos' },
    { key: 'facturacion-cancelar',       nombre: 'Cancelar facturas',      descripcion: 'Cancelar ante el SAT una factura ya timbrada' },
    { key: 'nota-credito',               nombre: 'Emitir notas de crédito', descripcion: 'Generar y cancelar notas de crédito (CFDI de egreso) contra una factura' },
  ...
  configuracion: [
    ...
    { key: 'canales-portal', nombre: 'Editar canales del Portal de Cliente', descripcion: 'Configurar WhatsApp, Messenger, teléfono, correo, sitio web y horario que ven las empresas cliente en su portal' },
    { key: 'notificar-correo', nombre: 'Notificar por correo', descripcion: 'Enviar aviso por correo a este usuario cuando ocurra un evento relevante del módulo' },
  ],
  'direccion-general': [
