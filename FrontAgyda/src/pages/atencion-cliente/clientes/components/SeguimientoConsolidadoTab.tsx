import { History, ClipboardList, CalendarClock, ListTree } from 'lucide-react'
...
// Fase 7: agrupa 4 pestañas viejas (bitácora / tareas / renovaciones /
// historial) bajo una sola de nivel superior, con sub-tabs internos.
export type SubSeguimiento = 'bitacora' | 'tareas' | 'renovaciones' | 'historial'
...
export function SeguimientoConsolidadoTab({ contactoId, sub, onSubChange }: {
  contactoId: number
  sub: SubSeguimiento
