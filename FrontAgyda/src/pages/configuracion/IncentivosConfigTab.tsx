...
const VARIABLES_AYUDA = [
  ...
  { nombre: 'montoComision', desc: 'Comisión calculada para el asesor en el periodo' },
]
...
function AyudaFormula() {
  return (
    <div className="rounded-xl border border-blue-100 bg-blue-50/60 p-3 space-y-2">
      ...
      <p className="text-[0.68rem] text-blue-700">
        Ejemplos: <code className="font-mono">{'IF(pctCumplimiento >= 100, 500, 0)'}</code> · <code className="font-mono">ventas * 50</code>
      </p>
    </div>
  )
}
...
export function IncentivosConfigTab() {
  const qc = useQueryClient()
    ...
    <div className="space-y-5">
      <div className="rounded-2xl border border-gray-100 bg-card p-5 shadow-card">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <h2 className="text-[1.35rem] font-bold text-gray-900">Incentivos</h2>
            <p className="text-[0.82rem] text-gray-400">
              Fórmulas de bono por desempeño, mostradas en CRM → Incentivos. Todas las activas se evalúan y se suman por asesor.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-gray-100 bg-card p-5 shadow-card">
        <div className="flex items-center justify-between mb-3">
          <div>
            <h3 className="text-sm font-bold text-ink">Fórmulas de incentivo</h3>
      ...
      <div className="flex items-start gap-2 rounded-xl bg-violet-50/60 px-3 py-2.5">
        ...
        <p className="text-[0.72rem] text-gray-500">
          También puedes gestionar estas fórmulas directamente desde CRM → Incentivos.
        </p>
      </div>
