...
// Contenido real de "Mi día — estado y tiempos personales". Vive en su propio
// archivo (sin depender de AsesoresPage ni de LivechatPage) para que ambos
// puedan importarlo sin crear un ciclo de módulos: AsesoresPage renderiza
// LivechatPage como vista principal, y LivechatPage abre este panel en un
