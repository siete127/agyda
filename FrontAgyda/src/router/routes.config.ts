...
export const ROUTES: RouteConfig[] = [
  ...
  { path: '/banio',            label: 'Reporte de Pausas', icon: 'Footprints',         moduleKey: 'reports',          roles: ['AD','TI'],          showInSidebar: true  },
  ...
  { path: '/contact-center/registros', label: 'Registros de formularios', icon: 'CalendarCheck', moduleKey: 'contact-center', roles: ['AD','TI','CC'], showInSidebar: true, description: 'Lo capturado en un formulario, con las citas próximas primero' },
