...
export const ROUTES: RouteConfig[] = [
  ...
  { path: '/atencion-cliente/ofertas',      label: 'Ofertas',      icon: 'Gift',        moduleKey: 'atencion-cliente', roles: INT, showInSidebar: true, description: 'Campañas de oferta a segmentos de clientes por correo y WhatsApp' },
